...
function prev_vendedor_out(array $r): array
{
    return [
        ...
        'supervisor_id'    => isset($r['supervisor_id']) && $r['supervisor_id'] !== null ? (int)$r['supervisor_id'] : null,
        'supervisor_nombre' => $r['supervisor_nombre'] ?? null,
...
function prev_msg_vars_contrato(array $c): array
{
    ...
    return [
        ...
        'cedula'          => (string)($c['cliente_documento'] ?? ''),
